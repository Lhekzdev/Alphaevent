...
const Onboardingleft = () => {
  ...
  const handleClickInsideMenu = (e) => {
    e.stopPropagation(); // Prevents the event from bubbling to the parent or outside of the menu.
  };
    ...
    <div className="flex">
      <div
        ...
        className={`${isMenuOpen ? "block" : "hidden"
          } absolute transition-all opacity-100 menu sm:duration-500 sm:ease-in-out top-20 md:top-0  md:flex md:relative pt-[24px] pr-[10px] pb-[151px] pl-[28px] bg-customdarkblue z-10 w-[280px] h-40md:h-[1024px] hover:opacity-100 md:opacity-100`}
      >
