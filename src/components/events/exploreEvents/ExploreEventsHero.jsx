  ...
  */
  ...
  return (
    <div className="px-5 md:px-[80px] pt-[60px] my-[60px]">
      <div
        loading="lazy"
        className="bg-cover bg-black opacity-[100%] bg-center h-[409px] rounded-[28px] w-full"
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dqtyrjpeh/image/upload/v1772991945/container_3_gz2hso.png')",
        }}
      >
        <div className="flex flex-col text-[16px] gap-y-[71px] text-white items-center justify-center px-[10px] w-full pt-[118px]">
...
export default ExploreEventsHero;
