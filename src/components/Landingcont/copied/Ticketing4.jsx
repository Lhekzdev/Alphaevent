...
{/* checked */}
          ...
          <div
              ref={ticketTypes2Ref}
              className="ticketTypes2 border border-[#757575] rounded-[12px] w-full lg:w-[738px] px-[40px] py-[30px] mt-[28px]"
            >
  ...
  <div className="flex flex-col lg:flex-row justify-center gap-[10px] mt-[32px] ">
                 ...
                 <img
                  src={delectIcon}
                  alt="Delete Icon"
                  className="deleteIcon2 cursor-pointer"
                  onClick={clearTicketTypes2Inputs}
                />
