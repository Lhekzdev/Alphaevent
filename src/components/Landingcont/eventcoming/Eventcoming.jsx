...
<ol className='text-white text-center items-center md:items-end max-w-[361px] px-8 md:px-0 md:max-w-[361px]   lg:max-w-[361px] flex flex-col  gap-y-[32px] h-[223px] md:h-[169px] md:mr-[88px] '>
    ...
    <button className='border font-normal  bg-white py-[14px]  w-[155px] text-customRed h-[50px] text-[16px] leading-[16px]  rounded-[10px] text-center items-center'> <Link to="/signUp">Create Event</Link> </button>
</ol>
