...
const Eventcoming = () => {
  return (
    <div className='  items-center bg-[#E7470D] justify-between pt-[52px] md:flex pb-5  flex-col md:flex-row w-full md:h-[274px] '>
...
<ol className='text-white text-center items-center md:items-end max-w-[361px] px-8 md:px-0 md:max-w-[361px]   lg:max-w-[361px] flex flex-col  gap-y-[32px] h-[223px] md:h-[169px] md:mr-[88px] '>
    ...
    <button className='border font-normal  bg-white py-[14px]  w-[155px] text-[#E7470D] h-[50px] text-[16px] leading-[16px]  rounded-[10px] text-center items-center'> <Link to="/signUp"><h2 className='mx-auto text-center w-[90px] h-[16px]'>Create Event</h2></Link> </button>
</ol>
