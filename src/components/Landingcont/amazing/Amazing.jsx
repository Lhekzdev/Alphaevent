  ...
  return (
    <div className=' font-Lato px-5 md:px-[80px] w-full  items-center py-[60px]'>
      <div className='h-full md:h-[87px] mb-[40px] md:mb-[60px] w-full mx-auto items-center  text-center  '>
        <h4 className='text-[25px] w-full text- md:text-[28px] lg:text-[30px] leading-[25px] md:leading-[36px] mb-[10px]  md:mb-[25px]  md:h-[36px] lg:mb-3 font-bold'>Find Your Next <span className='text-[#E7470D]'>  Amazing  </span>Experience Right Here</h4>
