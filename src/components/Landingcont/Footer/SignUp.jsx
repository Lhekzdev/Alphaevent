...
export const SignUp = () => (
  <section className="w-full   font-Lato">
    <div className="max-w-[1280px] pt-6  bg-[#FFFFFF] flex flex-wrap justify-between rounded-[30px] px-[40px] overflow-hidden shadow-md">
  ...
  />
                ...
                <button
  type="submit"
  className="px-6 py-2 bg-[#FF6B6B] text-white rounded-[10px] hover:bg-customdarkblue transition flex items-center justify-center gap-2"
>
  Subscribe
