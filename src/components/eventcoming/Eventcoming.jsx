...
<ol className='text-white max-w-[361px] px-8 md:px-0 md:max-w-[361px]  lg:max-w-[361px] flex flex-col gap-y-[32px] h-[169px]  md:mr-[348px]'>
    ...
    <button className='border font-normal bg-white py-[14px] px-[32px] w-[155px] text-customRed h-[50px] text-[16px] leading-[16px] items-center  rounded-[10px] text-left'> Create Event</button>
</ol>
